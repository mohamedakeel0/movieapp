...
import 'package:cleanapp/movies/domain/entities/genres.dart';
import 'package:cleanapp/movies/domain/entities/recommendation.dart';
import 'package:cleanapp/movies/presentation/controler/movie_details_bloc.dart';
...
import 'package:cleanapp/movies/presentation/screens/dummy.dart';
...
class MovieDetailContent extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<MovieDetailsBloc,MovieDetailsState>(
      buildWhen: (previous, current) => previous.movieDetailsState !=
          current.movieDetailsState,
      ...
      switch(state.movieDetailsState ) {
        ...
        case RequestState.error:
          return SizedBox(height: 170,child: Center(child: Text(state.detailsMessage),),);
      }
  ...
  Widget _showRecommendations() {
    return BlocBuilder<MovieDetailsBloc,MovieDetailsState>(
        buildWhen: (previous, current) => previous.recommendationState !=
